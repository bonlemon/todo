...
var store = _redux.redux.createStore(_redux.redux);
// create store
...
// execute set state
store.dispatch({
    type: _constants.ACTIONS.SET_STATE,
    payload: {
        tasks: "go!"
    }
});
...
_reactDom.ReactDOM.render(_react.React.createElement(
    ...
    { store: store },
    _react.React.createElement(_index2.default, null)
...
function reducer() {
    ...
    switch (action.type) {
        case _constants.ACTIONS.SET_STATE:
            return state.merge(action.payload);
        case _constants.ACTIONS.ADD_TASK:
            return state.update("tasks", function (tasks) {
                tasks.push(action.payload.task);
            });
        case _constants.ACTIONS.REMOVE_TASK:
            return state.update("tasks", function (tasks) {
                tasks.filterNot(function (item) {
